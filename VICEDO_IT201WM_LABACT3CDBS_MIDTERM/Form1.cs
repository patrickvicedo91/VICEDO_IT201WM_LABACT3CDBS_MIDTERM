...
namespace VICEDO_IT201WM_LABACT3CDBS_MIDTERM
{
    public partial class AppShell : Form
    {
        ...
        private void HandleActionEvaluate(object sender, EventArgs e)
        {
            PerformAssessment();
        }

        private void HandleActionClear(object sender, EventArgs e)
        {
            ClearFields();
        }
        ...
        private void OpenChildFormA(object sender, EventArgs e)
        {
            var f = new ChildFormA();
            f.Show();
        }

        private void OpenChildFormB(object sender, EventArgs e)
        {
            var f = new ChildFormB();
            f.Show();
        }
